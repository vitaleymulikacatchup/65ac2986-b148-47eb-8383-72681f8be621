...
export const metadata: Metadata = {
  title: "Saveur - Fine Dining Restaurant | Culinary Excellence",
  description: "Experience exceptional dining at Saveur. Fresh ingredients, passionate craftsmanship, and unforgettable culinary experiences in an elegant atmosphere.",
  keywords: ["fine dining", "restaurant", "gourmet food", "culinary excellence", "fresh ingredients", "chef signature dishes"],
  openGraph: {
    ...
    siteName: "Saveur",
    images: [{
      url: "https://images.pexels.com/photos/34450955/pexels-photo-34450955.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Saveur - Fine Dining Restaurant",
    description: "Experience exceptional dining with fresh ingredients and passionate craftsmanship",
    images: ["https://images.pexels.com/photos/34450955/pexels-photo-34450955.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
